...
def colorize(img_in,img_out):
	#args = parse_args()


    #Default params
    prototxt = cwd + '/FlaskAPI/Models/colorization_deploy_v2.prototxt'
    caffemodel = cwd + '/FlaskAPI/Models/colorization_release_v2.caffemodel'
    gpu = 0
    pts_in_hull_dir = cwd + '/FlaskAPI/resources/pts_in_hull.npy'
    ...
    pts_in_hull = np.load(pts_in_hull_dir) # load cluster centers
